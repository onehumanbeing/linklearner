(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 41404))
 (memory $0 1)
 ...
 (data $81 (i32.const 8332) "\1c")
 (data $81.1 (i32.const 8344) "\02\00\00\00\08\00\00\00t\00e\00s\00t")
 (data $82 (i32.const 8368) "B\00\00\00 \00\00\00 \00\00\00 ")
 (data $82.1 (i32.const 8392) " \00\00\00\00\00\00\00\02\01\00\00\02\t\00\00A\00\00\00\00\00\00\00 ")
 (data $82.2 (i32.const 8428) " \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 ")
 (data $82.3 (i32.const 8532) " \00\00\00\00\00\00\00 ")
 (data $82.4 (i32.const 8556) " ")
 (data $82.5 (i32.const 8588) " \00\00\00\00\00\00\00 ")
 (data $82.6 (i32.const 8612) " \00\00\00\00\00\00\00\01\01\00\00\00\00\00\00 ")
 (table $0 7 7 funcref)
 ...
 (func $~lib/rt/itcms/Object#makeGray (param $0 i32)
  ...
  block $__inlined_func$~lib/rt/itcms/Object#unlink$854
   local.get $0
   i32.load offset=4
   i32.const -4
   i32.and
   ...
   if
    ...
    br $__inlined_func$~lib/rt/itcms/Object#unlink$854
   end
   local.get $0
   i32.load offset=8
   local.tee $2
 ...
 (func $~lib/@artela/aspect-libs/types/aspect-interface/IPreContractCallJP#preContractCall@override (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  block $folding-inner1
 ...
 (func $~lib/@artela/aspect-libs/types/aspect-interface/IPostContractCallJP#postContractCall@override (param $0 i32) (param $1 i32)
  ...
  block $folding-inner0
   ...
   if
    ...
    local.get $0
    i32.store
    block $__inlined_func$~lib/@artela/aspect-libs/common/abi/ethereum/index/ethereum.parseMethodSig$780
     local.get $0
     ...
     if
      ...
      i32.const 1696
      local.set $0
      br $__inlined_func$~lib/@artela/aspect-libs/common/abi/ethereum/index/ethereum.parseMethodSig$780
     end
     global.get $~lib/memory/__stack_pointer
     local.get $0
     i32.store offset=8
 ...
 (func $~lib/@artela/aspect-libs/types/aspect-entry/EntryPoint#isOwner (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 20
   ...
   loop $while-continue|0
    ...
    if
     ...
     block $case8|1
      ...
      local.get $0
      i32.store offset=12
      block $__inlined_func$~lib/as-proto/assembly/Reader/Reader#string@override$870
       local.get $0
       i32.const 8
       i32.sub
       i32.load
       ...
       if
        ...
        i32.add
        global.set $~lib/memory/__stack_pointer
        br $__inlined_func$~lib/as-proto/assembly/Reader/Reader#string@override$870
       end
       unreachable
      end
      global.get $~lib/memory/__stack_pointer
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$871
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 1696
     local.set $0
     br $__inlined_func$~lib/string/String#concat$871
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
  ...
  block $folding-inner1
   block $folding-inner0
    ...
    if
     ...
     global.get $~lib/memory/__stack_pointer
     local.set $2
     block $__inlined_func$~instanceof|~lib/@artela/aspect-libs/types/aspect-interface/IPreContractCallJP$435 (result i32)
      global.get $~lib/memory/__stack_pointer
      local.get $0
      i32.store
      global.get $~lib/memory/__stack_pointer
      ...
      i32.const 31
      i32.ne
      br_if $__inlined_func$~instanceof|~lib/@artela/aspect-libs/types/aspect-interface/IPreContractCallJP$435
      drop
      i32.const 1
     end
     i32.eqz
 ...
 (func $~lib/util/string/strtol<i32> (param $0 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.set $0
   loop $while-continue|0
    block $__inlined_func$~lib/util/string/isSpace$645 (result i32)
     local.get $0
     i32.const 128
     i32.or
     i32.const 160
     ...
     i32.const 5760
     i32.lt_u
     br_if $__inlined_func$~lib/util/string/isSpace$645
     drop
     i32.const 1
     local.get $0
     i32.const -8192
     ...
     block $break|0
      ...
      i32.const 1
      br $__inlined_func$~lib/util/string/isSpace$645
     end
     i32.const 0
    end
    if
 ...
 (func $~lib/@artela/aspect-libs/common/helper/convert/hexToUint8Array (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  ...
  block $folding-inner0
   ...
   i32.const 8192
   i32.store
   block $__inlined_func$~lib/string/String#startsWith$874
    local.get $0
    i32.const 8188
    i32.load
    i32.const 1
    ...
    if
     ...
     i32.const 0
     local.set $0
     br $__inlined_func$~lib/string/String#startsWith$874
    end
    global.get $~lib/memory/__stack_pointer
    i32.const 1696
    i32.store
    ...
    i32.const 8192
    i32.store offset=4
    block $__inlined_func$~lib/util/string/compareImpl$8 (result i32)
     i32.const 1696
     local.set $4
     i32.const 8192
     local.set $2
     ...
     loop $while-continue|1
      ...
      if
       ...
       if
        ...
        local.get $1
        i32.sub
        br $__inlined_func$~lib/util/string/compareImpl$8
       end
       local.get $4
       i32.const 2
       i32.add
 ...
 (func $~lib/@artela/aspect-libs/common/helper/convert/toUint8Array<~lib/string/String> (param $0 i32) (result i32)
  ...
  block $folding-inner1
   block $folding-inner0
    ...
    local.get $1
    i32.store
    block $__inlined_func$~lib/@artela/aspect-libs/common/helper/convert/stringToUint8Array$876 (result i32)
     local.get $1
     i32.const 20
     i32.sub
     i32.load offset=16
     ...
     if
      i32.const 0
      call $~lib/typedarray/Uint8Array#constructor
      br $__inlined_func$~lib/@artela/aspect-libs/common/helper/convert/stringToUint8Array$876
     end
     global.get $~lib/memory/__stack_pointer
     local.get $1
     i32.store
 ...
 (func $~lib/string/String.UTF8.decodeUnsafe (param $0 i32) (param $1 i32) (result i32)
  ...
  block $__inlined_func$~lib/rt/itcms/__renew$853
   local.get $1
   local.get $0
   i32.sub
   local.tee $2
   ...
   if
    ...
    local.get $2
    i32.store offset=16
    br $__inlined_func$~lib/rt/itcms/__renew$853
   end
   local.get $2
   local.get $3
   i32.load offset=12
